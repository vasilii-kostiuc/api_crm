...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 24 2022 г., 01:25
...
CREATE TABLE `lead_comments` (
                                 ...
                                 `status_id` bigint(20) UNSIGNED DEFAULT NULL,
                                 `comment_value` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `menus` (`id`, `title`, `path`, `parent`, `type`, `sort_order`, `created_at`, `updated_at`) VALUES
                                                                                                            (1, 'Dashboard', 'dashboards.index', '0', 'admin', 100, NULL, NULL),
                                                                                                            (2, 'Child', 'dashboards.index', '1', 'admin', 100, NULL, NULL),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
                                                          ...
                                                          (4, '2021_12_17_215614_create_users_table', 2),
                                                          ...
                                                          (10, '2021_12_29_214351_create_menus_table', 4),
                                                          ...
                                                          (19, '2022_01_15_092636_create_lead_comments_table', 9);
...
INSERT INTO `oauth_access_tokens` (`id`, `user_id`, `client_id`, `name`, `scopes`, `revoked`, `created_at`, `updated_at`, `expires_at`) VALUES
                                                                                                                                            ('23a2b728b5f539ea5a2917d94fcd230b3490ad3b07eb50e7a73407d7db882715069c6d30cde47a11', 1, 1, 'Personal Access Token', '[]', 0, '2022-01-07 17:41:59', '2022-01-07 17:41:59', '2023-01-07 19:41:59'),
                                                                                                                                            ('5614bbff6fb12c6c1196e1d0995d2492301c54f55df1416dc4747ab1456bb0c3d208ae6653703cb1', 1, 1, 'Personal Access Token', '[]', 0, '2022-01-07 18:00:51', '2022-01-07 18:00:51', '2023-01-07 20:00:51'),
                                                                                                                                            ('7d652bec6c3e3c19d11a947408baffc56f2787023616b5eebf6d8d7aa68b508673232fad42e30e53', 1, 1, 'Personal Access Token', '[]', 0, '2021-12-20 19:49:06', '2021-12-20 19:49:06', '2022-12-20 21:49:06'),
                                                                                                                                            ('99f7815db2e5d36428fa5652cb347581f3da5ff906c5f538648000987700ce2f063919b9aa3b5f63', 1, 1, 'Personal Access Token', '[]', 0, '2022-01-07 17:12:01', '2022-01-07 17:12:01', '2023-01-07 19:12:01');
...
INSERT INTO `oauth_clients` (`id`, `user_id`, `name`, `secret`, `provider`, `redirect`, `personal_access_client`, `password_client`, `revoked`, `created_at`, `updated_at`) VALUES
                                                                                                                                                                                (1, NULL, 'Laravel Personal Access Client', 'j7CDX2k7Aags00zM0HaTd2r1LSodsjYykJm6AK7F', NULL, 'http://localhost', 1, 0, 0, '2021-12-20 19:48:56', '2021-12-20 19:48:56'),
                                                                                                                                                                                (2, NULL, 'Laravel Password Grant Client', 'ohMv3EzDBG7Rm7UdOSTYDiMpWUOfKoHRLPHeclBU', 'users', 'http://localhost', 0, 1, 0, '2021-12-20 19:48:56', '2021-12-20 19:48:56');
...
INSERT INTO `oauth_personal_access_clients` (`id`, `client_id`, `created_at`, `updated_at`) VALUES
    (1, 1, '2021-12-20 19:48:56', '2021-12-20 19:48:56');
...
INSERT INTO `roles` (`id`, `alias`, `title`, `created_at`, `updated_at`) VALUES
                                                                             (2, 'SUPER_ADMINISTRATOR', 'Super Admin', '2022-01-08 18:44:27', '2022-01-08 18:44:27'),
                                                                             (3, 'MANAGER', 'Manager', '2022-01-09 14:06:17', '2022-01-09 14:06:17');
